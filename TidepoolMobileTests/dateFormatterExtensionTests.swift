...
class dateFormatterExtensionTests: XCTestCase {
    ...
    func testAttributedStringFromDate() {
        ...
        let expected = NSMutableAttributedString(string: "Saturday 1/1/00 12:30pm", attributes: [NSForegroundColorAttributeName: UIColor.black, NSFontAttributeName: UIFont(name: "OpenSans", size: 12.5)!])
