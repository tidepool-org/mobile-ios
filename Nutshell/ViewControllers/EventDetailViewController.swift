...
class EventDetailViewController: BaseUIViewController {
    ...
    var graphBackground: UIImageView?
    ...
    override func viewDidLayoutSubviews() {
        ...
        if (self.graphBackground != nil) {
            if (self.graphBackground!.frame.size != graphSectionView.frame.size) {
        ...
        if (self.graphBackground == nil) {
            ...
            self.graphSectionView.setNeedsLayout()
            self.graphSectionView.layoutIfNeeded()
